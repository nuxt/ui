...
const range = {
  ...
  thumb: {
    ...
    ring: '',
    border: '[&::-webkit-slider-thumb]:border-2 [&::-moz-range-thumb]:border-2 [&::-webkit-slider-thumb]:border-solid [&::-moz-range-thumb]:border-solid [&::-webkit-slider-thumb]:border-current [&::-moz-range-thumb]:border-current',
    shadow: '[&::-webkit-slider-thumb]:shadow [&::-moz-range-thumb]:shadow',
    size: {
