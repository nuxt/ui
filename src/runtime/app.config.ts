...
const dropdown = {
  wrapper: "relative inline-flex ltr:text-left rtl:text-right",
  container: "z-20",
  width: "w-48",
  height: "",
...
const radio = {
  ...
  base: "h-4 w-4 rtl:mr-2 text-primary-500 dark:text-primary-400 focus-visible:ring-2 focus-visible:ring-offset-2 bg-white dark:bg-gray-900 dark:checked:bg-current dark:checked:border-transparent focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-900 border-gray-300 dark:border-gray-700 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-0 focus:ring-transparent focus:ring-offset-transparent",
...
const modal = {
  ...
  padding: "p-4 sm:p-0",
  base: "relative ltr:text-left rtl:text-right overflow-hidden sm:my-8 w-full flex flex-col",
  overlay: {
...
const notification = {
  ...
  progress: {
    base: "absolute bottom-0 start-0 end-0 h-1",
    background: "bg-{color}-500 dark:bg-{color}-400",
  },
  transition: {
