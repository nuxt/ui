...
export default defineLocale<Messages>({
  ...
  messages: {
    ...
    chatReasoning: {
      ...
      thoughtFewSeconds: 'Бірнеше секунд ойланды',
      thoughtSeconds: '{duration} секунд ойланды',
      thoughtMinute: '{duration} минут ойланды',
      thoughtMinutes: '{duration} минут ойланды'
    },
    selectMenu: {
      create: '"{label}" жасау',
      noData: 'Деректер жоқ',
