...
export type TabsSlots<Items> = DynamicSlots<Items, null, 'leading' | 'trailing' | 'content' | 'default'> extends infer S ? { [K in keyof S]: SlotProps<S[K]> } & Record<string, any> : never
