<template>
  <Listbox v-slot="{ open, disabled }" v-model="selectedOption" as="div" class="relative">
    ...
    <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
      <ListboxOptions class="absolute z-10 mt-1 w-full bg-white max-h-60 rounded-md py-1 text-base ring-1 u-ring-gray-200 overflow-auto focus:outline-none sm:text-sm">
        <ListboxOption
