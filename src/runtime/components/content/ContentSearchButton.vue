...
const ui = computed(() => tv(theme, appConfig.ui?.contentSearchButton)({
...
<template>
  <DefineButtonTemplate>
    <UButton
      ...
      data-slot="content-search-button"
      v-bind="{
        ...buttonProps,
        ...(props.collapsed ? {
          'square': true,
    ...
    >
      ...
      <template #trailing="{ ui: uiProxy }">
        <div data-slot="content-search-button-trailing" :class="ui.trailing({ class: props.ui?.trailing })">
