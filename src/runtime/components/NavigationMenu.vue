  ...
  <DefineLinkTemplate v-slot="{ item, active, index }">
    <slot :name="((item.slot || 'item') as keyof NavigationMenuSlots<T>)" :item="item" :index="index" :active="active" :ui="ui">
      ...
      <span
        ...
        data-slot="linkLabel"
        :class="ui.linkLabel({ class: [uiProp?.linkLabel, item.ui?.linkLabel, shouldHideLabel(item) && 'hidden'] })"
      >
      ...
      <component
        ...
        :class="ui.linkTrailing({ class: [uiProp?.linkTrailing, item.ui?.linkTrailing, shouldHideLabel(item) && 'hidden'] })"
        @click.stop.prevent
      >
