...
export interface DropdownMenuItem extends Omit<LinkProps, 'type' | 'raw' | 'custom'> {
  ...
  ui?: Pick<DropdownMenu['slots'], 'item' | 'label' | 'itemLeadingIcon' | 'itemLeadingAvatarSize' | 'itemLeadingAvatar' | 'itemLabel' | 'itemLabelExternalIcon' | 'itemTrailing' | 'itemTrailingIcon' | 'itemTrailingKbds' | 'itemTrailingKbdsSize'>
  [key: string]: any
}
