...
import theme from '../theme/pricing-plans'
...
<template>
  <Primitive :as="props.as" :data-orientation="props.orientation" data-slot="pricing-plans" :class="ui.root({ class: [props.ui?.root, props.class] })" :style="{ '--count': count }">
    <slot>
      <UPricingPlan
