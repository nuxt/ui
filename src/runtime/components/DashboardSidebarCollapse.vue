...
export interface DashboardSidebarCollapseProps extends ButtonProps {
  side?: 'left' | 'right'
}
</script>
...
<template>
  <UButton
    v-bind="{
      ...buttonProps,
      'icon': icon || (sidebarCollapsed ? appConfig.ui.icons.panelOpen : appConfig.ui.icons.panelClose),
