...
export type CheckboxGroupEmits<T extends CheckboxGroupItem[] = CheckboxGroupItem[], VK extends GetItemKeys<T> = 'value'> = CheckboxGroupRootEmits<GetModelValue<T, VK, true>> & {
  change: [event: Event]
}
