...
import { useAppConfig, useLocale, useComponentUI } from '#imports'
  ...
  <Primitive :as="as" data-slot="root" :class="ui.root({ class: [uiProp?.root, props.class] })">
    <slot :open="open" :remove-file="removeFile" :ui="ui">
      ...
      >
        ...
        <div v-if="position === 'inside' ? (multiple ? !(modelValue as File[])?.length : !modelValue) : true" data-slot="wrapper" :class="ui.wrapper({ class: uiProp?.wrapper })">
