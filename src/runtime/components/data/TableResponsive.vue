      ...
      <thead :class="ui.thead">
        <tr :class="ui.tr.base">
          ...
          <th
            ...
            scope="col"
            :class="[
              responsive['default']?.columns.includes(column.key) ? 'table-cell' : 'hidden',
              responsive['sm']?.columns.includes(column.key) ? 'sm:table-cell' : 'sm:hidden',
              responsive['xl']?.columns.includes(column.key) ? 'xl:table-cell' : 'xl:hidden',
              responsive['3xl']?.columns.includes(column.key) ? '3xl:table-cell' : '3xl:hidden',
              ui.th.base,
              ui.th.padding, ui.th.color, ui.th.font, ui.th.size, column.class]"
...
export default defineComponent({
  ...
  props: {
    ...
    responsive: {
      type: Object as PropType<{ [key: string]: { columns: string[] } }>,
      default: () => ({})
    },
    columns: {
