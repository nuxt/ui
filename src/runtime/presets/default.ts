...
const button = {
  ...
  variant: {
    ...
    black: 'shadow-sm border border-transparent u-text-white u-bg-gray-800 hover:u-bg-gray-900 disabled:u-bg-gray-700 focus:ring-2 focus:ring-offset-2 focus:u-bg-gray-900',
