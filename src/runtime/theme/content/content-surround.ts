...
export default defineTheme({
  slots: {
    ...
    link: 'group block px-6 py-8 rounded-lg border border-default hover:bg-elevated/50 outline-primary/25 focus-visible:outline-3 focus-visible:border-primary transition-colors',
    ...
    linkLeadingIcon: 'size-5 shrink-0 text-highlighted group-hover:text-primary transition-[color,translate] ease-out motion-reduce:transition-none',
