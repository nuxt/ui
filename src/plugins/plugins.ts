...
export default function PluginsPlugin(options: NuxtUIOptions) {
  ...
  plugins.unshift(resolvePathSync('../runtime/unplugin/plugins/head', { extensions: ['.ts', '.mjs', '.js'], url: import.meta.url }))
  if (options.colorMode) {
    plugins.push(resolvePathSync('../runtime/unplugin/plugins/color-mode', { extensions: ['.ts', '.mjs', '.js'], url: import.meta.url }))
  }
