    ...
    getContents: () => `
      ...
      module.exports = {
        ...
        plugins: [
          ...
          iconsPlugin(${Array.isArray(moduleOptions.icons) ? `{ collections: getIconCollections(${JSON.stringify(moduleOptions.icons)}) }` : typeof moduleOptions.icons === 'object' ? JSON.stringify(moduleOptions.icons) : {}})
        ],
        content: {
          files: [
