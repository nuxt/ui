...
export default (options: Required<ModuleOptions>) => {
  return defuFn({
    slots: {
      ...
      content: 'max-h-[min(15rem,var(--reka-combobox-content-available-height,15rem))] w-(--reka-combobox-trigger-width) bg-default shadow-lg rounded-md ring ring-default overflow-hidden data-[state=open]:animate-[scale-in_100ms_var(--ui-ease-out)] data-[state=closed]:animate-[scale-out_100ms_var(--ui-ease-out)] origin-(--reka-combobox-content-transform-origin) pointer-events-auto flex flex-col',
