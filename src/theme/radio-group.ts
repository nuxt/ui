...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    ...
    base: 'rounded-full ring ring-inset ring-accented overflow-hidden outline-transparent focus-visible:outline-2 focus-visible:ring focus-visible:ring-inset',
  ...
  variants: {
    color: {
      ...Object.fromEntries((options.theme.colors || []).map((color: string) => [color, {
        base: `focus-visible:outline-${color}/25 focus-visible:ring-${color}/50`,
        indicator: `bg-${color}`
      }])),
      neutral: {
        base: 'focus-visible:outline-primary/25 focus-visible:ring-primary/50',
