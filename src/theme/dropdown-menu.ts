...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    content: 'min-w-32 max-h-(--reka-dropdown-menu-content-available-height) bg-default shadow-lg rounded-md ring ring-default overflow-hidden data-[state=open]:animate-[scale-in_100ms_var(--ui-ease-out)] data-[state=closed]:animate-[scale-out_100ms_var(--ui-ease-out)] origin-(--reka-dropdown-menu-content-transform-origin) flex flex-col',
