...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    ...
    base: 'shrink-0 flex items-center justify-center rounded-sm text-(--ui-text-inverted) ring ring-inset ring-(--ui-border-accented) focus-visible:outline-2 focus-visible:outline-offset-2',
