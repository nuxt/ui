...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    root: 'gap-2',
    base: 'relative overflow-hidden rounded-[calc(var(--ui-radius)*625)] bg-[--ui-bg-accented]',
    indicator: 'rounded-[calc(var(--ui-radius)*625)] size-full transition-transform duration-200 ease-out',
