    ...
    variants: {
      ...
      size: {
        xs: {
          ...
          segment: 'data-[segment=day]:w-6 data-[segment=month]:w-8 data-[segment=year]:w-9'
        },
        sm: {
        ...
        md: {
          base: (prev: string) => [prev, 'gap-0.5'],
          segment: 'data-[segment=day]:w-7 data-[segment=month]:w-9 data-[segment=year]:w-11'
        },
        lg: {
        ...
        xl: {
          base: (prev: string) => [prev, 'gap-0.75'],
          segment: 'data-[segment=day]:w-8 data-[segment=month]:w-10 data-[segment=year]:w-13'
        }
      }
    },
    compoundVariants: [{
