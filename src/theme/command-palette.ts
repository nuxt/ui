...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    ...
    itemLeadingIcon: ['shrink-0 size-5 text-[--ui-text-dimmed] group-data-highlighted:text-[var(--ui-text)]', options.theme.transitions && 'transition-colors'],
    ...
    itemLabelBase: 'text-[--ui-text-highlighted] [&>mark]:text-[var(--ui-bg)] [&>mark]:bg-[var(--ui-primary)]',
    itemLabelPrefix: 'text-[var(--ui-text)]',
    itemLabelSuffix: 'text-[--ui-text-dimmed] [&>mark]:text-[var(--ui-bg)] [&>mark]:bg-[var(--ui-primary)]'
  }
})
