...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    ...
    cellTrigger: ['m-0.5 relative flex items-center justify-center whitespace-nowrap focus-visible:ring-2 focus:outline-none data-disabled:text-muted data-unavailable:line-through data-unavailable:text-muted data-unavailable:pointer-events-none data-today:font-semibold', options.theme.transitions && 'transition'],
