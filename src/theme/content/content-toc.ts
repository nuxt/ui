...
export default (options: Required<ModuleOptions>) => ({
  slots: {
    ...
    trigger: 'group text-sm font-semibold flex-1 flex items-center gap-1.5 py-1.5 -mt-1.5 outline-primary/25 focus-visible:outline-3',
    title: 'truncate',
    ...
    item: 'min-w-0',
    itemWithChildren: '',
    link: 'group relative text-sm flex items-center outline-primary/25 focus-visible:outline-3 py-1',
    linkText: 'truncate',
    indicator: '',
    indicatorLine: '',
    indicatorActive: ''
