...
<template>
  <UForm ref="form" :state="state" :schema="schema" :class="pg.w_full" @submit="onSubmit">
    <div :class="pg.grid_sm_grid_cols_2_md_grid_cols_3_gap_4">
      <UFormField label="Input" name="input">
        <UInput v-model="state.input" placeholder="you@example.com" :class="pg.w_full" />
      </UFormField>

      <UFormField name="inputNumber" label="InputNumber">
        <UInputNumber v-model="state.inputNumber" placeholder="Enter a number" :class="pg.w_full" />
      </UFormField>
      ...
      <UFormField name="inputDate" label="InputDate">
        <UInputDate v-model="state.inputDate" :class="pg.w_full" />
      </UFormField>

      <UFormField name="inputTime" label="InputTime">
        <UInputTime v-model="state.inputTime" :class="pg.w_full" />
      </UFormField>

      <UFormField name="inputTags" label="InputTags">
        <UInputTags v-model="state.inputTags" placeholder="Add a tag..." :class="pg.w_full" />
      </UFormField>

      <UFormField name="inputMenu" label="InputMenu">
        <UInputMenu v-model="state.inputMenu" :items="items" placeholder="Search an option..." :class="pg.w_full" />
      </UFormField>

      <UFormField name="inputMenuMultiple" label="InputMenu (Multiple)">
        <UInputMenu v-model="state.inputMenuMultiple" multiple :items="items" placeholder="Search options..." :class="pg.w_full" />
      </UFormField>

      <UFormField label="Textarea" name="textarea">
        <UTextarea v-model="state.textarea" placeholder="Write your message..." :class="pg.w_full" :rows="1" />
      </UFormField>

      <UFormField name="select" label="Select">
        <USelect v-model="state.select" :items="items" placeholder="Choose an option" :class="pg.w_full" />
      </UFormField>

      <UFormField name="selectMultiple" label="Select (Multiple)">
        <USelect v-model="state.selectMultiple" multiple :items="items" placeholder="Choose options" :class="pg.w_full" />
      </UFormField>

      <div :class="pg.hidden_md_block" />

      <UFormField name="selectMenu" label="SelectMenu">
        <USelectMenu v-model="state.selectMenu" :items="items" placeholder="Search an option..." :class="pg.w_full" />
      </UFormField>

      <UFormField name="selectMenuMultiple" label="SelectMenu (Multiple)">
        <USelectMenu v-model="state.selectMenuMultiple" multiple :items="items" placeholder="Search options..." :class="pg.w_full" />
      </UFormField>

      <div :class="pg.hidden_md_block" />

      <UFormField name="listbox" label="Listbox">
        <UListbox v-model="state.listbox" :items="items" :class="pg.w_full" />
      </UFormField>

      <UFormField name="listboxMultiple" label="Listbox (Multiple)">
        <UListbox v-model="state.listboxMultiple" :items="items" multiple :class="pg.w_full" />
      </UFormField>
      ...
      <UFormField name="slider" label="Slider">
        <USlider v-model="state.slider" :class="pg.mt_2_5" />
      </UFormField>
