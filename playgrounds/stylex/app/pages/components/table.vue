...
const columns: TableColumn<Payment>[] = [{
  ...
  meta: {
    class: {
      td: pg.text_center_font_semibold,
      th: pg.text_right_text_green_500_w_48
    }
  },
  cell: ({ row }) => {
  ...
  cell: ({ row }) => {
    ...
    return h(UBadge, { class: pg.capitalize, variant: 'subtle', color }, () => row.getValue('status'))
  },
  size: 102
}, {
...
<template>
  ...
  <div :class="pg.flex_flex_col_flex_1_gap_4_w_full_max_h_calc_100vh_7rem">
    <UContextMenu :items="contextmenuItems">
      <UTable
        ...
        sticky
        :class="pg.border_border_accented_rounded_sm"
        @select="onSelect"
    ...
    <div :class="pg.flex_items_center_justify_between_gap_3">
      <div :class="pg.text_sm_text_muted">
        {{ table?.tableApi?.getFilteredSelectedRowModel().rows.length || 0 }} of
        {{ table?.tableApi?.getFilteredRowModel().rows.length || 0 }} row(s) selected.
      </div>

      <div :class="pg.flex_items_center_gap_1_5">
        <UPagination
          :disabled="!!virtualize"
