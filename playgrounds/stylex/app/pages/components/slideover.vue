...
<template>
  ...
  <div :class="pg.flex_flex_col_gap_2_min_h_0">
    <USlideover title="First slideover" :inset="inset">
      ...
      <template #body>
        <Placeholder :class="pg.size_full" />
      </template>
    ...
    <USlideover title="Slideover with custom close button" description="The `close` prop inherits from the Button props." :close="{ color: 'primary', variant: 'solid', size: 'xs' }" :ui="{ close: pg.top_3_5_rounded_full }" :inset="inset">
