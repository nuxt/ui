...
<template>
  ...
  <div :class="pg.flex_flex_col_gap_2_min_h_0">
    ...
    <UModal title="Modal scrollable" description="This modal has `scrollable: true` prop. Content scrolls within the overlay, preventing accidental closes on scrollbar clicks." scrollable>
      ...
      <template #body>
        <Placeholder :class="pg.h_300vh_w_full" />
      </template>
    ...
    <UModal title="Modal with custom close button" description="The `close` prop inherits from the Button props." :close="{ color: 'primary', variant: 'solid', size: 'xs' }" :ui="{ close: pg.top_3_5_rounded_full }">
