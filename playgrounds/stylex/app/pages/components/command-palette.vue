...
<template>
  <Navbar>
    ...
    <UDrawer should-scale-background>
      ...
      <template #content>
        <ReuseTemplate :class="pg.border_t_border_default_mt_4" />
      </template>
    </UDrawer>
  ...
  <DefineTemplate>
    <UCommandPalette
      ...
      :class="pg.sm_max_h_96"
      @update:model-value="onSelect"
    >
      <template #footer>
        <div :class="pg.flex_items_center_justify_between_gap_2">
          <UIcon name="i-simple-icons-nuxtdotjs" :class="pg.size_5_text_dimmed_ml_1" />
          <div :class="pg.flex_items_center_gap_1">
            ...
            <USeparator orientation="vertical" :class="pg.h_4" />
  ...
  <UCard :ui="{ body: pg.important_p_0 }" :class="pg.w_xl">
    <UCommandPalette
      v-if="virtualize"
      virtualize
      :size="size"
