...
describe('Button', () => {
  ...
  it.each([
    ...
    ['with loadingPosition leading', { props: { loading: true, loadingPosition: 'leading', label: 'Button' } }],
    ['with loadingPosition center', { props: { loading: true, loadingPosition: 'center', label: 'Button' } }],
    ['with loadingPosition trailing', { props: { loading: true, loadingPosition: 'trailing', label: 'Button' } }],
