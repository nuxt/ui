...
describe('InputMenu', () => {
  ...
  renderEach(InputMenu, [
    ...
    // Autocomplete
    ['with mode autocomplete', { props: { ...props, mode: 'autocomplete' as const } }],
    ['with mode autocomplete and modelValue', { props: { ...props, mode: 'autocomplete' as const, modelValue: 'Backlog' } }],
    ['with mode autocomplete and defaultValue', { props: { ...props, mode: 'autocomplete' as const, defaultValue: 'Backlog' } }],
    ['with mode autocomplete and placeholder', { props: { ...props, mode: 'autocomplete' as const, placeholder: 'Type something...' } }],
    ['with mode autocomplete and content', { props: { ...props, mode: 'autocomplete' as const, content: { hideWhenEmpty: true } } }],
