...
describe('Modal', () => {
  ...
  renderEach(Modal, [
    ...
    ['with fullscreen sm', { props: { ...props, fullscreen: 'sm' as const, title: 'Title', description: 'Description' } }],
    ...
    ['with scrollable and fullscreen sm', { props: { ...props, scrollable: true, fullscreen: 'sm' as const, title: 'Title', description: 'Description' } }],
