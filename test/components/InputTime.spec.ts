...
describe('InputTime', () => {
  ...
  renderEach(InputTime, [
    ...
    ['with range and model value', { props: { range: true, modelValue: { start: new Time(12, 30), end: new Time(14, 30) } } }],
    ['with range and default value', { props: { range: true, defaultValue: { start: new Time(12, 30), end: new Time(14, 30) } } }],
