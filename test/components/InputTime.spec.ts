...
describe('InputTime', () => {
  ...
  renderEach(InputTime, [
    ...
    ['with range and model value', { props: { range: true, defaultValue: [new Time(12, 30), new Time(14, 30)] } }],
    ['with range and default value', { props: { range: true, defaultValue: [new Time(12, 30), new Time(14, 30)] } }],
