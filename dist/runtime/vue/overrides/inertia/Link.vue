...
const props = defineProps({
  ...
  component: { type: [String, null], required: false },
  ...
  onHttpException: { type: Function, required: false },
  onNetworkError: { type: Function, required: false },
  ...
  pageProps: { type: [Object, Function, null], required: false },
