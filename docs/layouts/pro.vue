...
const links = computed(() => {
  const proComponents = Object.values(components.value).filter(component => runtimeConfig.uiProPath ? component.shortPath.startsWith(`${runtimeConfig.uiProPath}`) : component.shortPath.includes('@nuxt/ui-pro'))
