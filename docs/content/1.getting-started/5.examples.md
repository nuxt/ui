...
::callout{icon="i-simple-icons-github" to="https://github.com/nuxtlabs/ui/blob/dev/docs/components/content/examples/TabsThemeStepper.vue"}
Take a look at the component!
::
...
::component-example
#default
:tabs-theme-stepper-icons
::

::callout{icon="i-simple-icons-github" to="https://github.com/nuxtlabs/ui/blob/dev/docs/components/content/examples/TabsThemeStepperIcons.vue"}
Take a look at the component!
::
