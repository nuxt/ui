...
#default
:command-palette-example-theme-algolia{class="max-h-[480px] rounded-md"}
::
...
#default
:command-palette-example-theme-raycast{class="max-h-[480px] rounded-md"}
::
...
::component-example
#default
:vertical-navigation-example-theme-tailwind
#code
```vue
<script setup>
const links = [{
...
::component-example
#default
:pagination-example-theme-rounded
#code
```vue
<script setup>
const page = ref(1)
