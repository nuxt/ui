...
::component-example
#default
:table-example-advance
::

::alert{icon="i-simple-icons-github" to="https://github.com/nuxtlabs/ui/blob/dev/docs/components/content/examples/TableExampleAdvance.vue"}
Take a look at the component!
::
