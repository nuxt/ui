...
You can also change them programatically in your app
```vue [index.vue]
<script setup>
  const route = useRoute()
  const appConfig = useAppConfig()

  // Changing the primary & secondary colors based on current route
  watchEffect(() => {
    switch (route.path) {
      case 'docs':
        appConfig.ui.primary = 'emerald'
        appConfig.ui.secondary = 'netural'
        break
      case 'blog':
        appConfig.ui.primary = 'indigo'
        appConfig.ui.secondary = 'cool'
        break
      default:
        appConfig.ui.primary = 'green'
        appConfig.ui.secondary = 'slate'
        break
    }
  })
</script>
