...
::note
The values you assign here must correspond to color names from the [default Tailwind palette](https://tailwindcss.com/docs/colors) or be previously defined in your [CSS file](#theme)
::
