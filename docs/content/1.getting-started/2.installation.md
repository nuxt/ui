...
This module is installed to provide an easy way to use icons in your application. You can use the `Icon` component to display any icon from Iconify.

::callout{icon="i-heroicons-light-bulb"}
You can read more about this in the [Theming](/getting-started/theming#icons) section and on the [Icon](/components/icon) component page.
::
