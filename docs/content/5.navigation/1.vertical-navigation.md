...
Learn how to build a Tailwind themes vertical navigation in the [Examples](/getting-started/examples#verticalnavigation) page.
::

## Slots

You can use slots to customize items content.

### `default`

Use the `#default` slot to customize the item label. You will have access to the `link` and `isActive` in the slot scope.
...
Use the `#avatar` slot to customize the item avatar. You will have access to the `link` and `isActive` in the slot scope.
...
Use the `#icon` slot to customize the item icon. You will have access to the `link` and `isActive` in the slot scope.
...
Use the `#badge` slot to customize the item badge. You will have access to the `link` and `isActive` in the slot scope.
