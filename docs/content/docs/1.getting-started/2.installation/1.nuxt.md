...
Use the `prose` option to force the import of Nuxt UI [`Prose` components](/docs/typography) even if `@nuxtjs/mdc` or `@nuxt/content` is not installed.
...
### `mdc` :badge{label="Deprecated" color="warning" class="align-text-top"}
