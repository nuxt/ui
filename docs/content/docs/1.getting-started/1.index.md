...
A modern Vue UI component library built on [Reka UI](https://reka-ui.com/) and [Tailwind CSS](https://tailwindcss.com/) to ship beautiful and accessible applications with 125+ production-ready components. Works with Nuxt and plain Vue apps (Vite, Inertia, SSR).
...
Nuxt UI v5 is in alpha. Follow the progress in the [v5 tracking issue](https://github.com/nuxt/ui/issues/6918) and read the [migration guide](/docs/getting-started/migration) for the list of breaking changes.

## Core technologies

Nuxt UI is built on two foundations: Reka UI for behavior and accessibility, and Tailwind CSS for styling.
...
Nuxt UI ships its own variants engine to power the design system:

- **Dynamic Styling**: Flexible component variants with a concise API
...
- **Nuxt templates**: [Starter](https://starter-template.nuxt.dev), [Landing](https://landing-template.nuxt.dev), [Docs](https://docs-template.nuxt.dev), [SaaS](https://saas-template.nuxt.dev), [Dashboard](https://dashboard-template.nuxt.dev), [Chat](https://chat-template.nuxt.dev), [Portfolio](https://portfolio-template.nuxt.dev), [Changelog](https://changelog-template.nuxt.dev), [Editor](https://editor-template.nuxt.dev), and [Calendar](https://calendar-template.nuxt.dev)
- **Vue templates**: [Starter](https://starter-vue-template.nuxt.dev), [Dashboard](https://dashboard-vue-template.nuxt.dev), and [Chat](https://chat-vue-template.nuxt.dev)
...
Ask questions and get help in [GitHub Discussions](https://github.com/nuxt/ui/discussions/categories/q-a), chat with the community on [Discord](https://go.nuxt.com/discord), or report bugs on [GitHub](https://github.com/nuxt/ui/issues).
:::
