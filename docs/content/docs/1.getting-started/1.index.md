...
::note{to="/docs/components/accordion#with-custom-slot" aria-label="Accordion component with custom slot"}
...
- Read our [migration guide](/docs/getting-started/migration) to upgrade your project from v2 to v3.
