...
- [**Icons**](/docs/getting-started/icons): Access 200,000+ icons from Iconify
- [**Fonts**](/docs/getting-started/fonts): Plug-and-play web font optimization and configuration
- [**Color Mode**](/docs/getting-started/color-mode): Dark and Light mode with auto detection
- [**i18n**](/docs/getting-started/i18n): Internationalize your components with 50+ languages
- [**Content**](/docs/getting-started/content): Beautiful typography out of the box
...
- **Generic Components**: Using [Vue 3 Generics](https://vuejs.org/api/sfc-script-setup.html#generics)
- **Type-safe Theming**: In `app.config.ts`
- **IntelliSense**: Throughout your entire codebase

### Nuxt DevTools Integration

Play with Nuxt UI components directly from Nuxt DevTools with the [compodium](https://github.com/romhml/compodium) module:
