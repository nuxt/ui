...
Nuxt UI v5 is in alpha. Follow the progress in the [v5 tracking issue](https://github.com/nuxt/ui/issues/6918) and read the [migration guide](/docs/getting-started/migration/v5) for the list of breaking changes.
