...
To make development easier, we've created a CLI that you can use to generate components and locales. You can access it using the `pnpm nuxt-ui make` command.
...
pnpm nuxt-ui make component my-component

# Create a prose component
pnpm nuxt-ui make component heading --prose

# Create a content component
pnpm nuxt-ui make component block --content

# Generate only documentation template
pnpm nuxt-ui make component my-component --template=docs
```
...
```bash
pnpm nuxt-ui make locale --code <code>
```
