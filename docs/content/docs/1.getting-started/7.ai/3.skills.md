...
The usage skill gives AI agents comprehensive knowledge about building with Nuxt UI v5. It covers:
...
::u-button
---
to: "cursor://anysphere.cursor-deeplink/install-skill?url=https://github.com/nuxt/ui/tree/v5/skills/nuxt-ui"
label: Install Skill
color: neutral
...
```
https://github.com/nuxt/ui/tree/v5/skills/nuxt-ui
```
...
```bash
claude skill add https://github.com/nuxt/ui/tree/v5/skills/nuxt-ui
```
...
- **Skill entry point**: [`skills/nuxt-ui/SKILL.md`](https://github.com/nuxt/ui/tree/v5/skills/nuxt-ui/SKILL.md)
- **Full skill directory**: [`skills/nuxt-ui/`](https://github.com/nuxt/ui/tree/v5/skills/nuxt-ui)
