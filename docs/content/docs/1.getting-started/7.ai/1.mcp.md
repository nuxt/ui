...
::note{icon="i-lucide-info"}
**GitHub Agent requires GitHub Copilot** - Ensure you have an active GitHub Copilot subscription.
::

#### Setup Instructions:

1. Navigate to [GitHub Copilot Settings](https://github.com/settings/copilot)
2. Scroll down to the "Model Context Protocol (MCP) Settings" section
3. Add the following configuration to your MCP settings:
