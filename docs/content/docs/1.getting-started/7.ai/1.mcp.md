...
- **`get-template`**: Retrieves a template's description, features and links

### Example Tools

- **`list-examples`**: Lists the names of all available UI examples
- **`get-example`**: Retrieves the source code of a UI example

### Migration Tools

- **`get-migration-guide`**: Retrieves the migration guide and upgrade instructions for this version of Nuxt UI
...
3. Fill in the configuration form with:
   ...
   - **Tools**: `*`
4. Press <kbd>Ctrl</kbd>+<kbd>S</kbd> to save. The MCP server is available immediately without restarting the CLI.
