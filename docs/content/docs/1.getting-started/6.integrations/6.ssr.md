...
Nuxt UI bundles the icons it uses into your build, so they render during SSR and work fully offline once you install the icon collection locally, with no request to the Iconify API. See the [Icons](/docs/getting-started/integrations/icons/vue#collections) integration to set this up and to bundle your own icons.
