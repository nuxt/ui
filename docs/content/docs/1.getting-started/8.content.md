...
To make the most out of `@nuxt/content` / `@nuxtjs/mdc`, Nuxt UI provides custom implementations of all prose components directly within Nuxt UI. This gives us precise control over styling while ensuring perfect visual harmony with our design system.

::note{to="/docs/typography"}
Learn more about **Typography** system and all the available components.
::
