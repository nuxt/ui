...
Check out the [`Nuxt`](https://github.com/nuxt-ui-templates/dashboard){target="_blank"} and [`Vue`](https://github.com/nuxt-ui-templates/dashboard-vue){target="_blank"} Dashboard templates on GitHub for a real-life example.
::
...
::note{icon="i-simple-icons-github"}
Check out the [`Nuxt`](https://github.com/nuxt-ui-templates/chat){target="_blank"} and [`Vue`](https://github.com/nuxt-ui-templates/chat-vue){target="_blank"} AI Chat templates on GitHub for a real-life example.
::
