...
## Input events
The Form component automatically triggers validation upon `input`, `blur` or `change` events. This ensures that any errors are displayed as soon as the user interacts with the form elements. You can disable this using `disable-auto-validation`.
