<template>
  ...
  >
    <template #left>
      ...
      <UDropdown
        :items="[[{ label: 'v4.x', to: 'https://ui.nuxt.com' }, { label: 'v3.x', to: 'https://ui3.nuxt.com' }, { label: $route.path.startsWith('/pro') ? `v${pkg.version.split('-')[0]}` : `v${config.version}`, class: 'text-primary-500 dark:text-primary-400' }]]"
