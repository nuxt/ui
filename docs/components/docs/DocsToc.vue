<template>
  <div v-if="toc" class="sticky top-16 bg-white/75 dark:bg-gray-900/75 backdrop-blur group lg:self-start -mx-4 sm:-mx-6 lg:mx-0 px-4 sm:px-6 lg:pl-8 lg:pr-0">
    <div class="py-3 lg:py-8 border-b border-dashed u-border-gray-200 lg:border-0">
      <button class="flex items-center gap-2" tabindex="-1" @click="isTocOpen = !isTocOpen">
        ...
        <UIcon name="i-heroicons-chevron-right" class="lg:hidden w-4 h-4 transition-transform duration-100 transform u-text-gray-400" :class="[isTocOpen ? 'rotate-90' : 'rotate-0']" />
      </button>
