...
<template>
  <div class="my-5" :style="{ '--ui-header-height': '4rem' }">
    <div class="relative">
      ...
      <div v-if="component" class="flex justify-center border border-b-0 border-muted relative p-4 z-[1]" :class="[!options.length && 'rounded-t-md', props.class, { 'overflow-hidden': props.overflowHidden || props.elevated, 'bg-neutral-50 dark:bg-neutral-950/50': props.elevated }]">
